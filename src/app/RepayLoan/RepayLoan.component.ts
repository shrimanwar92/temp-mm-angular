...
import { RepayLoanService } from './RepayLoan.service';
import 'rxjs/add/operator/toPromise';
@Component({
	selector: 'app-RepayLoan',
	templateUrl: './RepayLoan.component.html',
	styleUrls: ['./RepayLoan.component.css'],
  providers: [RepayLoanService]
})
export class RepayLoanComponent implements OnInit {
  ...
  constructor(private serviceRepayLoan:RepayLoanService, fb: FormBuilder) {
  ...
  loadAll(): Promise<any> {
    let tempList = [];
    return this.serviceRepayLoan.getAll()
    .toPromise()
    .then((result) => {
  ...
  addTransaction(form: any): Promise<any> {
    ...
    return this.serviceRepayLoan.addTransaction(this.Transaction)
    .toPromise()
    .then(() => {
			this.errorMessage = null;
      this.myForm.setValue({
   ...
   updateTransaction(form: any): Promise<any> {
    ...
    return this.serviceRepayLoan.updateTransaction(form.get("transactionId").value,this.Transaction)
		.toPromise()
		.then(() => {
			this.errorMessage = null;
		})
  ...
  deleteTransaction(): Promise<any> {
    ...
    return this.serviceRepayLoan.deleteTransaction(this.currentId)
		.toPromise()
		.then(() => {
			this.errorMessage = null;
		})
  ...
  getForm(id: any): Promise<any>{
    ...
    return this.serviceRepayLoan.getTransaction(id)
    .toPromise()
    .then((result) => {
			this.errorMessage = null;
      let formObject = {
